...
const AnimationsGallery = (): JSX.Element => {
    return(
        <GalleryWrapper>
            <AnimationWrapper>
                <motion.div className={classes.MotionCircle}
                    whileTap={{scale: [1, 2]}}
            ...
            <AnimationWrapper>
                <motion.div className={classes.MotionSquare}
            ...
            <AnimationWrapper>
                <motion.div className={classes.MotionSquare}
                    whileTap={{scaleX: [1, 2, 2, 2, 1, 1], scaleY: [1, 1, 2, 2, 2, 1], opacity: [1, 1, 0.5, 0.5, 0.5, 1]}}
