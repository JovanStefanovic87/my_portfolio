...
const Input = (props: InputProps): JSX.Element => {
  ...
  const animateOutHandler = (e: React.FormEvent<HTMLInputElement>) =>
    e.currentTarget.value ? '' : setLabel(animateIn)
  ...
  return (
    <div className={inputElement.valid ? inputClasses.valid : inputClasses.invalid}>
      ...
      <input
        ...
        value={props.value}
        onChange={(e) => {
          inputChangedHandler(e, props.name, props.formInput, props.setFormInput)
        }}
